...
from PyQt5.QtWidgets import QFrame, QLabel, QGridLayout, QGraphicsOpacityEffect, QSizePolicy, QToolButton, \
    QActionGroup, QVBoxLayout, QWidget, QApplication, QHBoxLayout, QProgressBar

from lib.deepfacelab import pathex
from lib.deepfacelab.qtex import QImage_from_np, QActionEx, QXMainWindow, QSize_to_np, QPoint_to_np, QImage_to_np, \
    QPoint_from_np, QSubprocessor, QXIconButton, QDarkPalette
from lib.gui.xseg.QCursorDB import QCursorDB
from lib.gui.xseg.QIconDB import QIconDB
from lib.gui.xseg.QImageDB import QImageDB
from lib.gui.xseg.QStringDB import QStringDB
from lib.image_alt import DflPng, SegIEPolys, SegIEPolyType, dist_to_edges, normalize_channels, read_image
...
def start(input_dirpath):
    ...
    root_path = Path(__file__).parents[2] / "lib/gui/xseg"
